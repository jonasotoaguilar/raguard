...
- No `pg_textsearch`/BM25 signal, cross-encoder reranking, or vector quantization change (retrieval signals frozen at FTS `simple` + `halfvec(1024)` + RRF).
